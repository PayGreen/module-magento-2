 ...
 */
class PGDomainServicesProcessorsManageXTimeTransactionProcessor extends PGDomainFoundationsProcessorsAbstractPaymentRecordManagementProcessor
{
     ...
     * @throws Exception
     */
    protected function refusedTransactionStep(PGDomainTasksTransactionManagementTask $task)
    {
