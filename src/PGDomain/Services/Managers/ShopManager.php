 ...
 * @method PGDomainInterfacesRepositoriesShopRepositoryInterface getRepository()
 */
class PGDomainServicesManagersShopManager extends PGFrameworkFoundationsAbstractManager
{
    /**
     * @param $id
