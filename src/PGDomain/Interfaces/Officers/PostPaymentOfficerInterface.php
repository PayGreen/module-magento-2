...
/**
 * Interface PGDomainInterfacesOfficersPostPaymentOfficerInterface
 * @package PGDomain\Interfaces\Officers
 */
interface PGDomainInterfacesOfficersPostPaymentOfficerInterface
{
    /**
     * @param PGDomainInterfacesPostPaymentProvisionerInterface $provisioner
