...
class PGModuleServicesListenersOrderValidationListener
{
    ...
    public function __construct(ObjectManager $magento, PGFrameworkServicesLogger $logger)
    {
        $this->magento = $magento;
        $this->logger = $logger;
    }

    public function saveOrderHistory(PGDomainComponentsEventsOrderEvent $event)
    {
    ...
    /**
     * @param PGDomainComponentsEventsOrderEvent $event
     * @throws LocalizedException
     * @throws Exception
     */
    public function createInvoice(PGDomainComponentsEventsOrderEvent $event)
    {
        /** @var Order $localOrder */
        $localOrder = $event->getOrder()->getLocalEntity();
