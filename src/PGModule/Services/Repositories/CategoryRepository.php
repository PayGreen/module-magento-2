...
class PGModuleServicesRepositoriesCategoryRepository extends PGModuleFoundationsAbstractMagentoRepository implements PGDomainInterfacesRepositoriesCategoryRepositoryInterface
{
     ...
     * @return PGModuleEntitiesCategory
     */
    public function wrapEntity($localEntity)
    {
        return new PGModuleEntitiesCategory($localEntity);
    }
