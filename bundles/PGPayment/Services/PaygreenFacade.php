 ...
 * @package PGPayment\Services
 */
class PGPaymentServicesPaygreenFacade extends PGSystemFoundationsObject
{
    ...
    /** @var APIPaymentServicesApiFacade|null */
    ...
    /**
     * @return null|APIPaymentServicesApiFacade
     */
    ...
    public function getStatusShop()
    {
        ...
        $cacheHandler = PGSystemServicesContainer::getInstance()->get('handler.cache');
        ...
        if ($data === null) {
            try {
                ...
                if (empty($response->data)) {
                    throw new PGPaymentExceptionsPaygreenAccountException(
                        'Account data is empty.',
                        PGPaymentExceptionsPaygreenAccountException::ACCOUNT_NOT_FOUND
                    );
                }
                ...
                if ($dataShop === null) {
                    throw new PGPaymentExceptionsPaygreenAccountException(
                        'Shop is empty.',
                        PGPaymentExceptionsPaygreenAccountException::EMPTY_SHOP_DATA
                    );
                }
            ...
            } catch (PGClientExceptionsResponseFailed $exception) {
                throw new PGPaymentExceptionsPaygreenAccountException(
