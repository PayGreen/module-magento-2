...
/**
 * Interface PGPaymentInterfacesEntitiesButtonInterface
 * @package PGPayment\Interfaces\Entities
 */
interface PGPaymentInterfacesEntitiesButtonInterface extends PGDatabaseInterfacesEntityPersisted
{
    /**
     * @return int
     */
    ...
    /**
     * @param PGShopInterfacesEntitiesCategory[] $categories
     * @return self
     */
