 ...
 */
class PGServerServicesRenderersProcessorsOutputTemplateProcessor extends PGSystemFoundationsObject
{
    ...
    public function __construct(
        ...
        PGFrameworkServicesHandlersOutputHandler $outputHandler
    ) {
