 ...
 */
class PGTreeServicesOutputBuildersCarbonBot extends PGModuleFoundationsOutputBuilder
{
    ...
    public function __construct(PGServerServicesHandlersLink $linkHandler, PGModuleServicesSettings $settings)
    {
        parent::__construct();
    ...
    public function build(array $data = array())
    {
        ...
        $output->addResource(new PGServerComponentsResourcesDataResource(array(
        ...
        $output->addResource(new PGServerComponentsResourcesScriptFileResource('/js/climatebot.js'));
