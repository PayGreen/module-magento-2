...
/**
 * Class PGClientServicesRequestersCurl
 * @package PGClient\Services\Requesters
 */
class PGClientServicesRequestersCurl extends PGClientFoundationsRequester
{
    private $bin;
     ...
     * @return mixed|PGClientComponentsResponse
    ...
    protected function getHttpVersionOption()
    {
        ...
        switch ($http_version) {
            ...
            case '3.0':
                ...
                break;
            default:
                throw new PGClientExceptionsResponse("Unknown CURLOPT_HTTP_VERSION option : '$http_version'.");
        }
    ...
    private function getCurlConstant($name, $httpVersion)
    {
        if (defined($name)) {
            ...
            throw new PGClientExceptionsResponse("Unknown '$name' option : '$httpVersion'.");
        }
    }
}
