 ...
 */
abstract class PGDatabaseFoundationsRepositoryPaygreen extends PGDatabaseFoundationsRepository implements PGDatabaseInterfacesRepositoryWrappedEntity
{
    /**
     * @return APIPaymentServicesApiFacade
     */
