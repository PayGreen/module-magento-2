 ...
 * @package PGShop\Services
 */
class PGShopServicesOrderStateMapper extends PGSystemFoundationsObject
{
    const STATE_UNKNOWN = 'UNKNOWN';

    /** @var PGShopInterfacesOrderStateMapperStrategy[] */
    ...
    public function getOrderState(array $source)
    {
        ...
        /** @var PGShopInterfacesOrderStateMapperStrategy $mapperStrategy */
