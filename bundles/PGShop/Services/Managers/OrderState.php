 ...
 * @method PGShopInterfacesRepositoriesOrderState getRepository()
 */
class PGShopServicesManagersOrderState extends PGDatabaseFoundationsManager
{
    /** @var PGShopServicesFactoriesOrderStateMachine */
    private $machineFactory;

    public function __construct(
        PGDatabaseInterfacesRepository $repository,
        PGShopServicesFactoriesOrderStateMachine $machineFactory
    ) {
