 ...
 * @method PGShopInterfacesRepositoriesCategory getRepository()
 */
class PGShopServicesManagersCategory extends PGDatabaseFoundationsManager
{
    ...
    public function __construct(
        PGDatabaseInterfacesRepository $repository,
    ...
    public function getRootCategories()
    {
        ...
        /** @var PGShopInterfacesEntitiesCategory[] $rootCategories */
     ...
     * @param PGShopInterfacesEntitiesCategory[] $productCategories
     * @return bool
     */
    public function isEligibleCategory(PGPaymentInterfacesEntitiesButtonInterface $button, array $productCategories)
    {
    ...
    protected function insertPaymentTypes()
    {
        ...
        /** @var PGPaymentInterfacesEntitiesCategoryHasPaymentTypeInterface $categoryPayment */
        foreach ($categoryPayments as $categoryPayment) {
            /** @var PGShopInterfacesEntitiesCategory|null $category */
