...
/**
 * Class ResetCharityAccessSettingsUpgrade
 * @package PGCharity\Services\Upgrades
 */
class ResetCharityAccessSettingsUpgrade implements UpgradeInterface
{
    /** @var SettingManager */
    ...
    public function apply(UpgradeComponent $upgradeStage)
    {
        ...
        foreach ($shops as $shop) {
            ...
            foreach ($settings as $name) {
                ...
                if ($setting !== null) {
                    if ($name !== 'charity_api_server' && $isApiServerModified) {
