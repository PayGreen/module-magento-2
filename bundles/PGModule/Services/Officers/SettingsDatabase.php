 ...
 */
class PGModuleServicesOfficersSettingsDatabase implements PGModuleInterfacesOfficersSettings
{
    /** @var PGModuleEntitiesSetting[] */
    ...
    public function __construct(
        ...
        PGShopInterfacesShopHandler $shopHandler = null
    ) {
