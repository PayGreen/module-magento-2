 ...
 */
class PGModuleServicesRepositoriesSetting extends PGDatabaseFoundationsRepositoryDatabase implements PGModuleInterfacesRepositoriesSetting
{
    /**
     * @inheritDoc
    ...
    public function findAllByPrimaryShop($id_shop = null)
    {
        ...
        /** @var PGModuleInterfacesEntitiesSetting[] $result */
