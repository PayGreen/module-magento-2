 ...
 */
class FOPaymentControllersCustomerReturn extends PGServerFoundationsAbstractController
{
    ...
    public function __construct(array $config, PGPaymentServicesProcessorsPaymentValidationProcessor $processor)
    {
    ...
    {
        /** @var PGPaymentComponentsTasksPaymentValidation $task */
        ...
        try {
            ...
            /** @var PGPaymentServicesProcessorsPaymentValidationProcessor $processor */
    ...
    {
        $config = new PGSystemComponentsBag();
