...
class DisplayEligibleAmountsPageAction extends StandardizedDisplayPageAction
{
    /**
     * @inheritDoc
     * @throws Exception
    ...
    public function process()
    {
        ...
        $scriptResource = new ScriptFileResourceComponent('/js/page-eligible-amounts.js');
