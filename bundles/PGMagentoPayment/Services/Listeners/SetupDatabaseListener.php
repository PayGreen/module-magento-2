...
class SetupDatabaseListener
{
    ...
    {
        $this->logger->info("Install Paygreen payment database schema.");

        $this->databaseHandler->runScript('PGMagentoPayment:clean.sql');
        $this->databaseHandler->runScript('PGMagentoPayment:schema.sql');
    }
    ...
    {
        $this->logger->info("Uninstall Paygreen payment database schema.");
