...
/**
 * Class DisplaySupportPageAction
 * @package BOModule\Services\Actions
 */
class DisplaySupportPageAction extends StandardizedDisplayPageAction
{
    /**
     * @inheritDoc
     * @throws Exception
    ...
    public function process()
    {
        ...
        return $response->addResource(new ScriptFileResourceComponent("/js/page-support.js"));
    }
}
