...
namespace PGI\Module\PGMagento\Services\Listeners;
...
class SetupDatabaseListener
{
    ...
    public function install()
    {
        ...
        $this->databaseHandler->runScript('PGMagento:clean.sql');
        $this->databaseHandler->runScript('PGMagento:schema.sql');
    }
